...
class VQVAE(nn.Module):
    ...
    def fhat_to_img(self, f_hat: torch.Tensor):
        return self.decoder(self.post_quant_conv(f_hat))#.clamp_(0, 1)
    ...
    # def img_to_idxBl_fhat(self, inp_img_no_grad: torch.Tensor, v_patch_nums: Optional[Sequence[Union[int, Tuple[int, int]]]] = None) -> List[torch.LongTensor]:    # return List[Bl]
    #     f = self.quant_conv(self.encoder(inp_img_no_grad))
